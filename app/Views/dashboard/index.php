...
?>
<div class="pagehead">
    <h1 class="card__title"><?= e(__('nav.dashboard')) ?> · <?= e($household['name'] ?? '') ?></h1>
    <div class="networth">
...
<div class="grid2">
    <section class="card">
        <h2 class="card__subtitle"><?= e(__('dash.by_category')) ?> · <?= e(__('dash.this_month')) ?></h2>
        <?php if ($breakdown === []): ?>
            ...
            <div class="chartrow">
                ...
                <ul class="legend">
                    <?php foreach ($breakdown as $i => $b): ?>
                        <li>
                            <span class="dot2" style="background:<?= e($b['color'] ?: $palette[$i % count($palette)]) ?>"></span>
                            <?= e($b['label']) ?><span class="muted"> · <?= e(money((float) $b['value'])) ?></span>
                        </li>
                    <?php endforeach; ?>
                </ul>
            </div>
